...
//	$comments = printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s">%4$s</time></a><span class="by-author"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'twentyeleven' ) . ' <span class="comments_number"> - <a href="%9$s">%8$s</a></span>',
...
//    $comments_nr = printf(
//        esc_html_x('%s','','marie'),
//        '<span class="comments-nr"><a href='.get_comments_link().'>'.get_comments_number().'</a></span>'
//    );
	echo '<span class="posted-on">' . $posted_on . '</span><span class="byline"> ' . $byline . '</span><span class="comments-nr"><a href="'.get_permalink().'"><i class="fa fa-comment fa-lg"></i>' . get_comments_number() . '</a></span>'; // WPCS: XSS OK
